...
png("data.table_atime_versions_5366.png",res = 600, width = 5, height = 3, unit = "in")
data.table_atime_versions_5366 = ggplot()+
  geom_line(aes(x = N, y = median, group = expr.name, colour = expr.name), data =  atime.list.5366$measurements)+
  geom_ribbon(aes(x = N, ymin = min, ymax = max, fill = expr.name), data = atime.list.5366$measurements, alpha = 0.5 )+
  scale_x_log10("N = number of columns",limits = c(1e1, 1e6), breaks = 10^seq(1,6))+
  scale_y_log10("Computation Time (Seconds)")+
  scale_fill_manual(values=atime.colors.1)+
  scale_color_manual(values=atime.colors.1)
directlabels::direct.label(data.table_atime_versions_5366, list(cex = 1, "right.polygons"))
dev.off()
```
...
data.table_atime_versions_5424 = ggplot()+
  ...
  scale_x_log10("N = number of columns",limits = c(1e1, 1e7), breaks = 10^seq(1,7))+
  scale_y_log10("Computation Time (Seconds)")+
  scale_fill_manual(values=atime.colors.1)+
  scale_color_manual(values=atime.colors.1)
...
png("data.table_atime_versions_4200.png",res = 600, width = 5, height = 3, unit = "in")
data.table_atime_versions_4200 = ggplot()+
  ...
  scale_x_log10("N = number of columns",limits = c(1e1, 1e5), breaks = 10^seq(1,5))+
  scale_y_log10("Computation Time (Seconds)")+
  scale_fill_manual(values=atime.colors.1)+
  scale_color_manual(values=atime.colors.1)
directlabels::direct.label(data.table_atime_versions_4200, list(cex = 1, "right.polygons"))
dev.off()
```
...
data.table_atime_versions_4646 = ggplot()+
  ...
  scale_x_log10("N = number of columns",limits = c(1e1, 1e5), breaks = 10^seq(1,7))+
  scale_y_log10("Computation Time (Seconds)")+
  scale_fill_manual(values=atime.colors.2)+
  scale_color_manual(values=atime.colors.2)
...
data.table_atime_versions_1534 = ggplot()+
  ...
  scale_x_log10("N = number of columns",limits = c(1e1, 1e8), breaks = 10^seq(1,6))+
  scale_y_log10("Computation Time (Seconds)")+
  scale_fill_manual(values=atime.colors.2)+
  scale_color_manual(values=atime.colors.2)
