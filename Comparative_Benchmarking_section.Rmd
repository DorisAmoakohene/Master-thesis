...
png("create_subject_pattern_atime.png",res = 300, width = 5, height = 3, unit = "in")
plot(atime.list)+
...
ggsave("create_subject_pattern_best.png", plot = d, width = 5, height = 3, unit = "in", dpi = 300)
```
...
ggsave("create_subject_pattern_pred.png", plot = f, width = 5, height = 3, unit = "in", dpi = 300)
